...
/** @file
  *  <em>GW INSTEK PSP Series</em> power supply driver
  *  @internal
  */
...
static const struct gw_instek_psp_model models[] = {
	{ GW_INSTEK_PSP_405, "GW INSTEK PSP-405",     "405", { 1, 20, 0.1 }, { 0, 10,   0.10 } },
	{ 0, NULL, NULL, { 0, 0, 0 }, { 0, 0, 0 }, },
};

SR_PRIV struct sr_dev_driver gwintek_psp_driver_info;
